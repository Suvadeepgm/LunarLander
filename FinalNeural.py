...
class LunarLanderFinalNew:
    ...
    def __init__(self):
        ...
        self.Lambda = 0.6 #
        self.learningRate=0.1 #learning rate initialization 0.1
        self.epoch=300 # number of epoch 200
        self.dWeight_xh = 0 
        self.dWeight_hy = 0
        self.dBias_xh = 0
        self.rmseList=[]
    ...
    def read(self):
        self.df = pd.read_csv(r"D:\NeuralNetwork\AssignmentCode\ce889_dataCollection.csv") #using pandas to read the data
